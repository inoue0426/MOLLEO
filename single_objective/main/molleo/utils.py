...
def from_yaml(work_dir, fitness_function, start_population, yaml_file, **kwargs):
...
if __name__ == "__main__":
    data = [
        [
            ...
            "C=C1C2=C(C(=O)N3NC=C(C)N3)C=CC(=C(C3=CC(NC)NC3[N+](=O)[O-])NN1C)C2(F)F",
        ],
        [
            "C[NH+]1CCCC[C@@H]1C1=NC(CN)=NN1C=CC=CN1N=NC2=CC=C([N+](=O)[O-])C=C21",
            "CC1(C)CCCC[C@@H]1C1=Nc2nn3nccc([N+](=O)[O-])cc-3ccn2NC(CN)=N1",
        ],
        [
            "O=C(NC1=CCCC1)NC1=CC=C(c2ccc(N3CC=CC3)c(N3CC=CC3)c2)C1",
            "C1=CN(C2=CC=C(C3=CC=NC(NC4=CCCC4)=C3)N=C2)C=CC1",
        ],
        [
            "N[N+](=O)C1=C(NC2=CC=CC(O[O-])=C2)N=CCC1",
            "N#Cc1ccnc(Nc2ccc(NC3=CCC(N)=C3N)cc2N)n1",
        ],
        ["FC1=CC=C(NC2=CC=CCN2)C1", "NC1C=C(F)CC(NC2=CC=CCN2)=C1"],
        ["C=Cc1ccc([N+](=O)[O-])cc1", "C=Cc1ccc(CNc2cc([N+](=O)[O-])ccc2C=C)cc1"],
        [
            "C1=C(Nc2ccc(-c3ccnc(NC4=CCCC4)c3)cn2)CCC1",
            "C1=CN(c2ccc(-c3ccnc(NC4=CCCC4)c3)nc2)C=CC1",
        ],
        ["Cc1cnc(Nc2ccnc(Nc3cccc(F)c3)c2)cc1C", "Cc1cnc(Nc2cccc(F)c2)cc1C"],
        [
            "O=C=CC(C(=O)N1N=NC2=CC=C([N+](=O)[O-])C=C21)[N+](=O)C#CC(=O)[O-]",
            "CN(C)C(=O)C#CC(=O)C(=O)N1C2=CN=CCC2=NN1C(=O)C(C)(C)C#CC(N)=O",
        ],
        [
            "C=C(O)ONC(=O)N1N=NC2=CC=C([N+](=O)[O-])C=C21",
            "C=C(C)ONC(=O)N1NC2=CC=CC2=NN1C(=O)NNC(=O)O",
        ],
    ]
    for elem in data:
