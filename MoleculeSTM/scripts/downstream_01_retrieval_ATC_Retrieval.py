...
from downstream_01_retrieval_Description_Pharmacodynamics_Retrieval import \
    RetrievalDataset
...
from MoleculeSTM.datasets import (DrugBank_Datasets_Graph_ATC,
...
if __name__ == "__main__":
    ...
    retrieval_datapath = "{}/{}_{}_{}".format(
        args.retrieval_folder, args.molecule_type, args.task, args.ATC_level
    )
