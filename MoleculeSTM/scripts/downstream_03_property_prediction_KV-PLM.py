...
from MoleculeSTM.utils import get_num_task_and_type, prepare_text_tokens
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="This is only for MegaMolBART.",
    )
    ...
    if args.training_mode == "fine_tuning":
        ...
        model_param_group = [{"params": linear_model.parameters()}]
